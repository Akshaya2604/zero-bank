...
public class AuthenticationPage {
	...
	public boolean isOnLoginPage() {
		...
		try {
			...
			Reports.generateReport(driver, extendTest, Status.PASS, "Login is successful");
		} catch (NoSuchElementException e) {
			actReasult= false;
			Reports.generateReport(driver, extendTest, Status.FAIL, "Login is unsuccessful");
		}
		return actReasult;
	}
	...
	public boolean signIn() {
		...
		try {
	        ...
	        actReasult= false;
	        Reports.generateReport(driver, extendTest, Status.FAIL,"Login Failed");
	    }
		return actReasult;
	}
	public void wrongSignIn() {
		 try {
		        ...
		        Reports.generateReport(driver, extendTest, Status.FAIL, "Login button click failed: " );
		    }
	}
	...
	public boolean accountSummary() {
		...
		try {
			...
			Reports.generateReport(driver, extendTest, Status.PASS, "Account summary found");
		} catch (NoSuchElementException e) {
			actReasult=false;
