...
//			Reports.generateReport(driver, extentTest, Status.PASS, message);
//		} catch (Exception e) {
//			actResult=false;
//			Reports.generateReport(driver, extentTest, Status.FAIL, message);
//		}
//		return actResult;
//	}
	public Boolean validateSuccessfulMessage(String msg) {
		...
		try {
			...
			Reports.generateReport(driver, extentTest, Status.PASS, msg);
		} catch (Exception e) {
			actResult = false;
			Reports.generateReport(driver, extentTest, Status.FAIL, msg);
		}
		return actResult;
	}
